...
CFLAGS   = -std='gnu11'   -fPIC $(WARNINGS) -I'$(abspath include)' $(DEFS) $(OMP_FLAGS)
CXXFLAGS = -std='gnu++11' -fPIC $(WARNINGS) -I'$(abspath include)' $(DEFS) $(OMP_FLAGS)
LDFLAGS  = $(OMP_FLAGS)
...
# Export CFLAGS, CXXFLAGS and LDFLAGS so recursive make calls work correctly
export CFLAGS
export CXXFLAGS
export LDFLAGS
