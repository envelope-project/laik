...
int main(int argc, char* argv[])
{
    ...
    laik_switchto_new_phase(a, laik_new_block_partitioner1(),
    ...
    laik_switchto_new_phase(a, laik_new_block_partitioner_iw1(getEW, 0),
                      LAIK_DF_CopyIn | LAIK_DF_CopyOut);
    ...
    if (laik_size(world) > 1) {
        ...
        assert(laik_data_get_group(a) == g2);
	mysum[3] = 0;
	if (laik_myid(g2) >= 0) {
	    // I am part of g2 
            laik_map_def1(a, (void**) &base, &count);
