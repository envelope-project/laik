...
int main(int argc, char* argv[])
{
    ...
    laik_switchto_partitioning(array, part1, LAIK_DF_CopyOut, LAIK_RO_None);
    ...
    laik_switchto_partitioning(array, part2, LAIK_DF_CopyIn | LAIK_DF_CopyOut, LAIK_RO_None);
    ...
    part3 = laik_new_partitioning(laik_new_block_partitioner_iw1(getEW, 0),
                                  world, space, 0);
    laik_switchto_partitioning(array, part3, LAIK_DF_CopyIn | LAIK_DF_CopyOut, LAIK_RO_None);
    ...
    if (laik_size(world) > 1) {
        ...
        part4 = laik_new_partitioning(laik_new_block_partitioner_tw1(getTW, 0),
                                      world, space, 0);
        laik_switchto_partitioning(array, part4, LAIK_DF_CopyIn | LAIK_DF_CopyOut, LAIK_RO_None);
    ...
    laik_switchto_partitioning(sumdata, sumpart2, LAIK_DF_CopyIn, LAIK_RO_None);
    if (laik_myid(world) == 0) {
        laik_map_def1(sumdata, (void**) &base, &count);
